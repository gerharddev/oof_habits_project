...
@router.get("/completed-habits/", response_model=list[schemas.CompletedHabitCreate], tags=["completed_habits"])
...
@router.get("/completed-habits/{habit-id}", response_model=list[schemas.CompletedHabitCreate],
...
@router.get("/completed-habits-by-id-detailed/{habit-id}", response_model=list[schemas.CompletedHabit],
            tags=["completed_habits"])
